...
func (c *StateReplaceProviderCommand) Run(rawArgs []string) int {
	...
	replaceDiags = replaceDiags.Append(backendDiags)
	...
	if isCloudMode(b) {
		...
		replaceDiags = replaceDiags.Append(schemaDiags)
	}
